...
if($_REQUEST['delete']=="1")
{
	...
	if($DADMINID > 0)
	{
		...
		{
			$error = "Lỗi: Không thể xóa khi chỉ có 1 quản trị viên.";
		}
	}
}
// DELETE END
...
if ($totalvideos > 0)
{
	...
	{	
		if($currentpage > 1) 
		{
			$pagelinks.="<a href='$adminurl/admins_manage.php?page=1$add1' title='first page'>Đầu Tiên</a>&nbsp;";
			$pagelinks.="<a href='$adminurl/admins_manage.php?page=$theprevpage$add1'>Trước</a>&nbsp;";
		};
		$counter=0;
		...
		{
			$pagelinks.="<a href='$adminurl/admins_manage.php?page=$thenextpage$add1'>Sau</a>&nbsp;";
			$pagelinks.="<a href='$adminurl/admins_manage.php?page=$toppage$add1' title='last page'>Cuối Cùng</a>&nbsp;";
		};
	}
}
else
