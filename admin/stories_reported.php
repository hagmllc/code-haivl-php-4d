...
if ($totalposts > 0)
{
	...
	{	
		if($currentpage > 1) 
		{
			$pagelinks.="<a href='$adminurl/stories_reported.php?page=1$add1' title='first page'>Đầu Tiên</a>&nbsp;";
			$pagelinks.="<a href='$adminurl/stories_reported.php?page=$theprevpage$add1'>Trước</a>&nbsp;";
		};
		$counter=0;
		...
		{
			$pagelinks.="<a href='$adminurl/stories_reported.php?page=$thenextpage$add1'>Sau</a>&nbsp;";
			$pagelinks.="<a href='$adminurl/stories_reported.php?page=$toppage$add1' title='last page'>Cuối Cùng</a>&nbsp;";
		};
	}
}
else
{
	$error = "Không tìm thấy bài đăng nào bị báo lỗi.";
}
