    <div id="scriptolution-soft-share" class="scriptolution-soft-box ">
        <div class="content">
            ...
            <form id="form-scriptolution-soft-share" class="modal" action="">
                <h3>Đăng thành công! <span id="post-share-dismiss-counter"></span></h3>
                <h4>Bài đăng của bạn được hiển thị trên trang&nbsp;<a href="{$baseurl}/vote" target="_blank">Bình chọn</a>. Để được nhiều bình chọn hãy chia sẻ nó với mọi người!</h4>
                ...
                <div class="field">
                	<p>Dán liên kết vào <b>email</b> hoặc <b>IM</b>:</p>
