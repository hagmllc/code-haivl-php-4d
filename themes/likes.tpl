    ...
    <div id="content-holder">		
        ...
        <div class="main-filter with-topping">
            <ul class="content-type">            
                ...
                <li><a class="current"  href="{$baseurl}/user/{$p.username|stripslashes}/likes"><strong>{$lang193}</strong> ({$t2})</a></li>            
            ...
            <div id="entries-content" class="list">
				...
				$(function(){
					$('#entries-content-ul').scrollPagination({
						'contentPage': '{/literal}{$baseurl}/{literal}likesmore.php?UID={/literal}{$p.USERID}{literal}',
