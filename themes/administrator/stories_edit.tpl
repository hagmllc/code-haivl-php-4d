                                        ...
                                        <fieldset id="group_fields4">
                                            <div class="hor-scroll">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="feat">Đặc Biệt </label></td>
                                                        <td class="value">
                                                        	<select name="feat" id="feat">
                                                            <option value="1" {if $story.feat eq 1}selected{/if}>Có</option>
                                                            <option value="0" {if $story.feat eq 0}selected{/if}>Không</option>
                                                            </select>
                                                        </td>
                                                        <td class="scope-label">[HIỂN THỊ TRÊN THANH BÀI ĐĂNG ĐẶC BIỆT TẠI TRANG CHỦ]</td>
                                                        <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
                                                        <td class="label"><label for="rec">Được Giới Thiệu </label></td>
                                                        <td class="value">
                                                        	<select name="rec" id="rec">
                                                            <option value="1" {if $story.rec eq 1}selected{/if}>Có</option>
                                                            <option value="0" {if $story.rec eq 0}selected{/if}>Không</option>
                                                            </select>
                                                        </td>
                                                        <td class="scope-label">[HIỂN THỊ NGẪU NHIÊN TRÊN MENU DỌC BÊN PHẢI]</td>
                                                        <td><small></small></td>
                                                    </tr>
                                                    <tr class="hidden">
                                                    ...
                                                    <tr class="hidden">
                                                        <td class="label"><label for="name">Hình Ảnh/Video </label></td>
