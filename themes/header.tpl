...
<title>{if $gagtitle ne ""}{$gagtitle}{else}{if $pagetitle ne ""}{$pagetitle} - {/if}{$site_name}{/if}</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="description" content="{if $gagtitle ne ""}{$gagtitle}{else}{if $pagetitle ne ""}{$pagetitle} - {/if}{if $metadescription ne ""}{$metadescription} - {/if}{$site_name}{/if}">
<meta name="keywords" content="{if $gagkeys ne ""}{$gagkeys}{else}{if $pagetitle ne ""}{$pagetitle},{/if}{if $metakeywords ne ""}{$metakeywords},{/if}{$site_name}{/if}">
<meta name="title" content="{if $gagtitle ne ""}{$gagtitle}{else}{if $pagetitle ne ""}{$pagetitle} - {/if}{$site_name}{/if}" />
<meta property="og:title" content="{if $gagtitle ne ""}{$gagtitle}{else}{if $pagetitle ne ""}{$pagetitle} - {/if}{$site_name}{/if}"/>
...
{if $viewpage eq "1"}{if $p.youtube_key != ""}<link rel="image_src" href="http://i.ytimg.com/vi/{$p.youtube_key|stripslashes}/0.jpg" / >{else}<link rel="image_src" href="{$purl}/{$p.pic}" / >{/if}{/if}
