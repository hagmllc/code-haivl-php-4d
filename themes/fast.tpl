<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtdz">
                ...
                <div class="post-container">
                    <div class="img-wrap">
                        ...
                        <a href="javascript:void(0);" onclick="$('#load-next').click();">
                        	<img src="{$purl}/{$p.pic}" id='fastimage'>
                        </a>
...
var  obj= jQuery.parseJSON(e);
$('h2').html(obj.title);
$('#fastimage').attr('src','{/literal}{$purl}{literal}'+'/'+obj.image);
