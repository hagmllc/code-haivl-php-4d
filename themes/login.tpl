    ...
    <div class="signup-wrapper">
        ...
        <div class="content">
            ...
            <form id="form-signup-login" class="generic" action="{$baseurl}/login" method="post">
                ...
                <div id="login-remember-block" class="field" style="font-size:14px">
                    <input type="checkbox" value="yes" name="remember" style="width:20px; border:0px; vertical-align: baseline">&nbsp;{$lang261}
                </div>
                <div class="action">
